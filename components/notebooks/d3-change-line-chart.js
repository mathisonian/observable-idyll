...
The change in AAPL stock price relative to its April 24, 2007 price of $93.24.`
    ...
    {
      name: "chart",
      inputs: ["d3","DOM","width","height","xAxis","yAxis","data","lineWidth","line"],
      value: (function(d3,DOM,width,height,xAxis,yAxis,data,lineWidth,line)
{
      ...
      value: (function()
{
  return [[0, 1], [1, 0], [2, 4]];
    ...
    },
    {
      name: "d3",
      inputs: ["require"],
      value: (function(_require){return(
_require("https://d3js.org/d3.v5.min.js")
)})
    },
    {
      name: "lineWidth",
