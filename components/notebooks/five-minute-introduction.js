// URL: https://beta.observablehq.com/@mathisonian/five-minute-introduction
...
(await d3.tsv("https://unpkg.com/world-atlas@1/world/110m.tsv"))
      ...
      value: (async function(require)
{
  ...
  const data = cars.map(({Name: name, Miles_per_Gallon: x, Horsepower: y}) => ({name, x, y}));
